...
export function JsIcon({ className }: IconProps) {
  return (
    ...
    >
      <path d="M9 3c-2 0-3 1-3 3v4c0 1.5-1 2-2 2 1 0 2 .5 2 2v4c0 2 1 3 3 3" />
      <path d="M15 3c2 0 3 1 3 3v4c0 1.5 1 2 2 2-1 0-2 .5-2 2v4c0 2-1 3-3 3" />
    </svg>
  );
}
...
export function JavaIcon({ className }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M6 9h10v8a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3V9z" />
      <path d="M16 12h1.5a1.5 1.5 0 0 1 0 3H16" />
      <path d="M9 3v4" />
      <path d="M13 2v5" />
    </svg>
  );
